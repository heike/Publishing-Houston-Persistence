...
\includegraphics[width=\textwidth,height=0.45\textheight]{Writeup-JCGS_files/figure-pdf/fig-matrixDAdjustments-1.pdf}
...
\includegraphics[width=0.75\textwidth,height=\textheight]{../figure/RPlot01.png}
...
is needed to ascertain the cause of such low scores. Overall, model
performance seems to stay relatively even until around bulllet 30, where
it tends to vary across bullets. Given the varied results of this data,
we cannot make any definitive claims regarding model performance across
bullet distance.
